...
#define EXYNOS4_GIC_CPU0_BASE		0x10480000
#define EXYNOS4_GIC_CPU1_BASE		0x10484000
#define EXYNOS4_GIC_CPU2_BASE		0x10488000
#define EXYNOS4_GIC_CPU3_BASE		0x1048C000
#define EXYNOS4_GICDIS_CPU0_BASE		0x10490000
#define EXYNOS4_GICDIS_CPU1_BASE		0x10494000
#define EXYNOS4_GICDIS_CPU2_BASE		0x10498000
#define EXYNOS4_GICDIS_CPU3_BASE	        0x1049C000
...
//base 0x10040000,so must add 0x10000
...
#define EXYNOS4X12_TZPC0_BASE		0x10110000
#define EXYNOS4X12_TZPC1_BASE		0x10120000
#define EXYNOS4X12_TZPC2_BASE		0x10130000
#define EXYNOS4X12_TZPC3_BASE		0x10140000
#define EXYNOS4X12_TZPC4_BASE		0x10150000
#define EXYNOS4X12_TZPC5_BASE		0x10160000
...
* Interrupts 
*/
#define EXYNOS4X12_GIC_BASE		0x10480000 
#define EXYNOS4X12_GIC_CPU0_BASE		0x10480000 
#define EXYNOS4X12_GIC_CPU1_BASE		0x10484000 
#define EXYNOS4X12_GIC_CPU2_BASE		0x10488000 
#define EXYNOS4X12_GIC_CPU3_BASE		0x1048C000 
#define GIC_ICCICR					0x00
#define GIC_ICCPMR					0x04
#define GIC_ICCBPR					0x08
#define GIC_ICCIAR					0x0C
#define GIC_ICCEOIR					0x10
#define GIC_ICCRPR					0x14
#define GIC_ICCHPIR					0x18
#define GIC_ICCABPR				0x1C
#define GIC_INTEG_EN_C				0x40
#define GIC_INTERRUPT_OUT			0x44
#define GIC_ICCIIDR					0xFC
#define EXYNOS4X12_GICDIS_BASE		0x10490000 
#define EXYNOS4X12_GICDIS_CPU0_BASE		0x10490000 
#define EXYNOS4X12_GICDIS_CPU1_BASE		0x10494000 
#define EXYNOS4X12_GICDIS_CPU2_BASE		0x10498000 
#define EXYNOS4X12_GICDIS_CPU3_BASE		0x1049C000
#define GIC_ICDISR0					0x80
#define GIC_ICDISER0				0x100
#define GIC_ICDICER0				0x180
#define GIC_ICDISPR0				0x200
#define GIC_ICDICPR0				0x280
#define GIC_ICDABR0				0x300
#define GIC_ICDIPR0					0x400
#define GIC_ICDIPR1					0x404
#define GIC_ICDIPR2					0x408
#define GIC_ICDIPR3					0x40C
#define GIC_ICDIPR4					0x410
#define GIC_ICDIPR5					0x414
#define GIC_ICDIPR6					0x418
#define GIC_ICDIPR7					0x41C
#define GIC_ICDIPTR0				0x800
#define GIC_ICDIPTR1				0x804
#define GIC_ICDIPTR2				0x808
#define GIC_ICDIPTR3				0x80C
#define GIC_ICDIPTR4				0x810
#define GIC_ICDIPTR5				0x814
#define GIC_ICDIPTR6				0x818
#define GIC_ICDIPTR7				0x81C
#define GIC_ICDICFR0				0xC00
#define GIC_ICDICFR1				0xC04
#define GIC_PPI_STATUS				0xD00

/*
 * 	Sdram control, DMC0. DMC1
 */
...
#define EXYNOS5_GIC_CPU0_BASE		0
#define EXYNOS5_GIC_CPU1_BASE		0 
#define EXYNOS5_GIC_CPU2_BASE		0
#define EXYNOS5_GIC_CPU3_BASE		0 
#define EXYNOS5_GICDIS_CPU0_BASE		0 
#define EXYNOS5_GICDIS_CPU1_BASE		0 
#define EXYNOS5_GICDIS_CPU2_BASE		0 
#define EXYNOS5_GICDIS_CPU3_BASE		0
...
#define EXYNOS5420_GIC_CPU0_BASE		0
#define EXYNOS5420_GIC_CPU1_BASE		0 
#define EXYNOS5420_GIC_CPU2_BASE		0
#define EXYNOS5420_GIC_CPU3_BASE		0 
#define EXYNOS5420_GICDIS_CPU0_BASE		0 
#define EXYNOS5420_GICDIS_CPU1_BASE		0 
#define EXYNOS5420_GICDIS_CPU2_BASE		0 
#define EXYNOS5420_GICDIS_CPU3_BASE		0
...
SAMSUNG_BASE(gic_cpu0, GIC_CPU0_BASE)
SAMSUNG_BASE(gic_cpu1, GIC_CPU1_BASE)
SAMSUNG_BASE(gic_cpu2, GIC_CPU2_BASE)
SAMSUNG_BASE(gic_cpu3, GIC_CPU3_BASE)
SAMSUNG_BASE(gicdis_CPU0, GICDIS_CPU0_BASE)
SAMSUNG_BASE(gicdis_CPU1, GICDIS_CPU1_BASE)
SAMSUNG_BASE(gicdis_CPU2, GICDIS_CPU2_BASE)
SAMSUNG_BASE(gicdis_CPU3, GICDIS_CPU3_BASE)
#endif
